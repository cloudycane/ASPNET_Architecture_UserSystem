...
namespace ManejoUsuarioMVC.Servicios
{
    ...
    public class RepositorioUsuarios : IRepositorioUsuarios
    {
        ...
        public async Task<int> CrearUsuario(Usuario usuario)
        {
            ...
            var id = await connection.QuerySingleAsync<int>($"INSERT INTO Usuarios(Email, EmailNormalizado, PasswordHash) VALUES (@Email, @EmailNormalizado, @PasswordHash); SELECT SCOPE_IDENTITY(); ", usuario);
            return id;
        }
